...
"""
 Elabore un programa que solicite al usuario la edad y calcule cuántos años 
    ...
    “Dentro de 5 años, tendrá:” y se muestra el valor de la edad proyectada
"""

# nombre = input('Porfavor digite su nombre: ')
...
# resultado_cuadrado = numero**2
# resultado_cubo = numero**3
